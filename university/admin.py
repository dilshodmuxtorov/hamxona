...
class DormitoryAdmin(admin.ModelAdmin):
    list_display = ("name", "university_id", "capacity")
    search_fields = ("name", "university_id__name")


@admin.register(RoomModel)
class RoomAdmin(admin.ModelAdmin):
    list_display = ("number", "floor", "capacity", "dormitory_id", "price")
    search_fields = ("number", "floor", "capacity", "dormitory_id__name")
